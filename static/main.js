...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\nvar commentList = document.getElementById(\"jsCommentList\");\nvar deleteButton = document.querySelectorAll(\"#jsDeleteButton\");\nvar commentNumber = document.getElementById(\"jsCommentNumber\");\n\nfunction minusCommentNumber() {\n  commentNumber.innerHTML -= 1;\n}\n\nfunction handleClick(_x) {\n  return _handleClick.apply(this, arguments);\n}\n\nfunction _handleClick() {\n  _handleClick = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {\n    var videoId, button, li, commentText;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            videoId = window.location.href.split(\"videos/\")[1];\n            button = event.target;\n            li = button.parentNode;\n            commentText = li.firstChild.innerHTML;\n            commentList.removeChild(li);\n            _context.next = 7;\n            return axios__WEBPACK_IMPORTED_MODULE_0___default()({\n              url: \"/api/\".concat(videoId, \"/delete\"),\n              method: \"post\",\n              data: {\n                commentText: commentText\n              }\n            });\n\n          case 7:\n            minusCommentNumber();\n\n          case 8:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n  return _handleClick.apply(this, arguments);\n}\n\nfunction init() {\n  deleteButton.forEach(function (button) {\n    button.addEventListener(\"click\", handleClick);\n  });\n}\n\nif (commentList) {\n  init();\n}\n\n//# sourceURL=webpack:///./assets/js/deleteComment.js?");
...
eval("__webpack_require__(/*! @babel/polyfill */\"./node_modules/@babel/polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! C:\\Users\\SeWon\\Documents\\wetube\\assets\\js\\main.js */\"./assets/js/main.js\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill_./assets/js/main.js?");
